...
namespace DataTablesTest
{
    ...
    public class IOLogDataService : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public void GetIOLogForDevice(string rRow)//int iDisplayLength, int iDisplayStart, int iSortCol_0, string sSortDir_0, string sSearch)//, string sSortDir_1, string sSearch)
        {
